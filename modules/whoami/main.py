...
def start(args):
    ...
    #whoami = subprocess.run(['C:\\Program Files\\Microsoft SDKs\\Azure\\CLI2\\wbin\\az.cmd', 'account', 'show', '--query', '{subscription:name, username: user.name, tenant:tenantId}'], stdout=subprocess.PIPE)
